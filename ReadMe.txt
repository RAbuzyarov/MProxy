...
11. Скрипт управления модемами написан на Python. Его можно запускать либо в отдельном контейнере с Python, либо установить прямо на хосте.
...
12. Как найти лог определенного контейнера Docker
